...
create_chroot()
{
	...
	[[ $release == buster || $release == bullseye || $release == focal || $release == hirsute || $release == impish || $release == jammy || $release == sid ]] && includes=${includes}",perl-openssl-defaults,libnet-ssleay-perl"
